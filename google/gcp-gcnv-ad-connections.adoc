...
NFS Kerberos에 대한 AES 암호화를 활성화하려면 https://docs.cloud.google.com/netapp/volumes/docs/plan-and-prepare/security-considerations["Google Cloud NetApp Volumes 문서를 참조하세요."^].
