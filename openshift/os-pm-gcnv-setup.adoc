...
* Helm 차트를 사용하여 OSD 클러스터에 Trident를 설치하십시오. Helm 차트 설치 방법에 대한 지침은 link:https://docs.netapp.com/us-en/trident/trident-get-started/kubernetes-deploy-helm.html["여기"]을 참조하십시오.
