...
* link:https://www.netapp.com/blog/aws-fsxo-blg-configure-hybrid-cloud-with-fsx-for-netapp-ontap-and-vmware-cloud-on-aws-sddc-using-vmware-hcx/["VMware HCX를 사용하여 AWS SDDC에서 FSx ONTAP 및 VMware Cloud로 하이브리드 클라우드 구성"]
...
* link:https://www.netapp.com/blog/vmware-optimize-storage-workloads/["모든 클라우드에서 스토리지 및 데이터 집약적인 VMware 워크로드 최적화"]
* link:https://www.netapp.com/blog/vmware-migrate-workloads-azure/["VMware 워크로드를 Azure VMware Solution으로 이전하시겠습니까? 먼저 이 글을 읽어보세요."]
